...
<div class="page-wrapper">
	<div class="content container-fluid bg-white">
		...
		<form id="defaultForm" method="post" class="m-b-30"  action="<?php echo base_url('chefs/addpost'); ?>"  enctype="multipart/form-data">
			<div class="row">
						...
						<tbody>
							<tr id='addr0'>
								<td class="form-group">
									...
									<td class="form-group">
										<input type="text" name="specialist[]"  placeholder='Enter specialist' class="form-control"/>
									</td>
								</tr>
								<tr id='addr1'></tr>
							</tbody>
