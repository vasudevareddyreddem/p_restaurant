   ...
   <div class="content container-fluid bg-white">
      ...
      <form id="defaultForm" method="post" class="m-b-30" action="<?php echo base_url('contactus/addpost');?>" enctype="multipart/form-data">
         ...
         <div class="row">
			...
			<div class="col-md-12">
               <div class="form-group">
                  <label>Iframe Location Address (Should Maintain width="100%" height="300")</label>
                  <textarea class="form-control" name="iframe_address" rows="5" placeholder="Enter Iframe Location Address"><?php echo isset($contact_details['iframe_address'])?$contact_details['iframe_address']:''; ?></textarea>
               </div>
            </div>
         </div>
         <div class="row">
   ...
   validators: {
   	...
   	notEmpty: {
		   ...
		   iframe_address: {
               validators: {
   	notEmpty: {
   		message: 'Iframe Location Address  is required'
   	}
   }
           },
   phone: {
