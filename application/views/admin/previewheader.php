              ...
              <nav id="main-nav-offcanvas" class="main-nav-wrapper">
                ...
                <div class="main-nav">
                  <ul id="main-nav" class="nav nav-pills">
                    <li class="<?php if($this->uri->segment(1)=='preview' && $this->uri->segment(2)==''){ echo "current-menu-item"; } ?>"><a href="<?php echo base_url('preview'); ?>" class="">Home</a>
                  
                    </li>
                    <li class="<?php if($this->uri->segment(1)=='preview' && $this->uri->segment(2)=='aboutus'){ echo "current-menu-item"; } ?>"><a href="<?php echo base_url('preview/aboutus'); ?>">About</a></li>
                   <li class="<?php if($this->uri->segment(1)=='preview' && $this->uri->segment(2)=='reservation'){ echo "current-menu-item"; } ?>"><a href="<?php echo base_url('preview/reservation'); ?>">Reservation</a></li>
                    <li class="<?php if($this->uri->segment(1)=='preview' && $this->uri->segment(2)=='menu'){ echo "current-menu-item"; } ?>"><a href="<?php echo base_url('preview/menu'); ?>">Menu</a>
                    </li>
                    <li class="<?php if($this->uri->segment(1)=='preview' && $this->uri->segment(2)=='contact'){ echo "current-menu-item"; } ?>"><a href="<?php echo base_url('preview/contact'); ?>">Contact</a></li>
                  </ul>
                </div>
              </nav>
            </div>
