            ...
            <div class="page-wrapper">
				...
				<form id="defaultForm" method="post" class="m-b-30" action="<?php  echo base_url('services/briefpost');?>" enctype="multipart/form-data">
								<div class="row"> 
								<div class="col-md-6"> 
									...
									<table class="table table-bordered table-hover" id="tab_logic">
										...
										<tbody>
											<tr id='addr0'>
												...
												<td class="form-group">
												<input type="text" name="paragraph[]"  placeholder='Enter Paragraph' style="max-width=100ch" class="form-control"/>
												</td>
											</tr>
											<tr id='addr1'></tr>
										</tbody>
